...
After having loaded `dplyr` the `TPP2D` package itself we start by loading an example dataset which is supplied with the package. Therefore, we use the `import2dDataset` function.     
